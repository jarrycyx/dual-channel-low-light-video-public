...
class Channel_Merge_Decoder_Add(nn.Module):

    def __init__(self, batchNorm=False, input_size=[240, 416], mode="train", frame_num=7):
        super(Channel_Merge_Decoder_Add, self).__init__()
